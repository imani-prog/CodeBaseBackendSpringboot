...
public class AdminDashboardServiceImplementation implements AdminDashboardService {
    ...
    public AdminDashboardResponse getDashboard() {
        ...
        // ── 12-month rolling window: covers all Jan–Dec labels across a full year ──
    ...
    /**
     * Returns a rolling window of {@code totalMonths} YearMonths ending at the
     * current month. With totalMonths=12 this always yields a full Jan–Dec spread
     * regardless of what month today falls on.
     */
